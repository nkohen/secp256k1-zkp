...
public class NativeSecp256k1Test {
    ...
    public static void testAdaptorSignBatch() throws AssertFailException {
        int numSigs = 3;

        byte[][] msg = {
            toByteArray("9BB3A7C4CF1C10C225FF6C78867352559C6B0AD43DA0744BF0744A1C520FB03A"),
            toByteArray("01CFB39B77E3F6D501926DFFB75A852D4C28D6D807A8A9344F782D33A3C1240A"),
            toByteArray("E4DEBEBDC71C66D0BDD4A4B694624AFE4A83CCA4C0210F123CC78CF271528CB4")
        };
        byte[][] adaptor = {
            toByteArray("038B3E8F09A59F17A3CC7B8BDF04038CD102CDBE6A9FFCFFF1A7A8EA749826F48D"),
            toByteArray("0330CD37877836B2AA66C8FF4335D68C8D55929B8C7B0E374787CA9909503D3A57"),
            toByteArray("032D2AD14878D3A10E4230897D110AC9C5CF33873B98AAB47F863E9F2074D40497")
        };
        byte[][] secKey = {
            toByteArray("00033065FBFD7BABE601089E75C463D16E8FB8C731ED520DE425585099E27F70"),
            toByteArray("D1F0F9F08C172D164DEDEFE27A683CF16B5347C82A3F34525A74D91A5207850F"),
            toByteArray("82CF4117D3995B7F0157B2ECD801CD309CEA455787568726BB3B5FC24310A075")
        };
        byte[][] auxRand = {
            toByteArray("580E40DCE3C772ED359FE6D9C1459702016845F1981ECC04E371B00E7B851ACA"),
            toByteArray("A803318FBD525D00A2D4777950E45AEC2BB283CC3C5D0702D57DDC0628F8CA49"),
            toByteArray("F990532461E6DEB10E3957EC2905F52A0DE780F8EB6084660E3CF5614175049E")
        };
        ...
        String[] expectedAdaptorSig = {
            ...
            "",
            ""
        };

        byte[][] resultArr = NativeSecp256k1.adaptorSignBatch(secKey, adaptor, msg, auxRand);

        for (int i = 0; i < numSigs; i++) {
            String adaptorSig = toHex(resultArr[i]);
            assertEquals(adaptorSig, expectedAdaptorSig[i], "testAdaptorSignBatch(" + i + ")");
        }
    }
